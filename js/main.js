...
const models = [
    ...
    // ========== AI辅助工具 (Affiliate) ==========
    {
        ...
        tagsEn: ["AI Writing","Knowledge Base","Calendar","Project Mgmt","All-in-One"],
        name: "Notion AI",
        company: "Notion Labs（美国）",
        category: "AI辅助工具",
        pricing: "freemium",
        priceLabel: "免费 / Plus $10/月",
        priceDetail: "免费版基础笔记 + 有限AI次数。Plus $10/月（无限AI + 日历/Database等全部功能）。Business $15/月/人。Affiliate返佣50%首年循环",
        website: "https://affiliate.notion.so/YOUR-PARTNER-CODE",
        tags: ["AI写作", "知识库", "日历", "项目管理", "All-in-One"],
        strengths: "All-in-One工作空间 + AI写作/改写/翻译集成。中文UI支持完善，国内无需科学上网。50%首年循环返佣，是目前中文用户最友好的AI笔记+写作工具",
        strengthsEn: "All-in-one workspace with integrated AI writing/rewriting/translation. Full Chinese UI, no VPN needed for mainland users. 50% first-year recurring commission — the most Chinese-user-friendly AI note-taking & writing tool.",
    ...
    },
    {
        ...
        tagsEn: ["Design","AI Image","Presentation","Video","Brand Kit"],
        name: "Canva Pro（可画）",
        company: "Canva（澳大利亚）",
        category: "AI辅助工具",
        pricing: "freemium",
        priceLabel: "免费 / Pro $12.99/月",
        priceDetail: "免费版基础设计功能。Pro $12.99/月（AI生成/背景移除/图片编辑/品牌套件）。Affiliate返佣$36/注册",
        website: "https://partner.canva.com/YOUR-PARTNER-CODE",
        tags: ["设计", "AI图像", "演示文稿", "视频", "品牌套件"],
        strengths: "中文品牌名'可画'，国内知名度极高。AI文字生图、智能抠图、批量设计功能强大。$36每次注册的固定佣金，对国内中文用户极其友好",
        strengthsEn: "Branded as '可画' in China with massive local awareness. AI text-to-image, smart background removal, batch design. $36 flat commission per signup — extremely Chinese-user-friendly.",
    ...
    },
    {
        ...
        tagsEn: ["Grammar Check","AI Rewrite","Plagiarism","Tone","Business"],
        name: "Grammarly",
        company: "Grammarly（美国/乌克兰）",
        category: "AI辅助工具",
        pricing: "freemium",
        priceLabel: "免费 / Premium $12/月",
        priceDetail: "免费版基础语法检查。Premium $12/月（AI改写/语气调整/查重/润色）。Business $15/月/人。90天Cookie——AI工具中最长之一",
        website: "https://grammarly.go2cloud.org/YOUR-PARTNER-CODE",
        tags: ["语法检查", "AI改写", "查重", "语气", "商务"],
        strengths: "全球最成熟的AI写作助手，90天超长Cookie。适合留学生、外企打工人、跨境电商写手。插件覆盖Chrome/Word/Google Docs全场景",
        strengthsEn: "The world's most mature AI writing assistant with 90-day cookie window. Ideal for international students, foreign enterprise workers, cross-border e-commerce. Plugins cover Chrome/Word/Google Docs everywhere.",
    ...
    },
    {
        ...
        tagsEn: ["AI Writing","SEO","Brand Voice","Templates","Enterprise"],
        name: "Jasper AI",
        company: "Jasper（美国）",
        category: "AI辅助工具",
        pricing: "freemium",
        priceLabel: "7天免费 / Creator $49/月",
        priceDetail: "Creator $49/月（单人，AI写作+SEO+Copyscape查重）。Pro $69/月（多人协作+品牌声音+Campaigns）。30%终身循环佣金——单次推荐终身收益",
        website: "https://partnerstack.com/go/jasper/YOUR-PARTNER-CODE",
        tags: ["AI写作", "SEO", "品牌声音", "模板", "企业"],
        strengths: "企业级AI写作工具标杆，品牌声音训练功能独一无二。30%终生循环佣金——推荐1个$49/月用户=每月赚$14.7。平均客户生命周期14个月+，单次推荐终身价值$200-600",
        strengthsEn: "Enterprise AI writing benchmark with unique brand voice training. 30% lifetime recurring commission — one $49/mo user = $14.7/mo forever. Avg customer lifetime 14+ months, single referral value $200-600.",
    ...
    },
    {
        ...
        tagsEn: ["Voice Clone","TTS","Dubbing","Voice Design","Audiobook"],
        name: "ElevenLabs",
        company: "ElevenLabs（美国/波兰）",
        category: "AI辅助工具",
        pricing: "freemium",
        priceLabel: "免费 / Starter $5/月",
        priceDetail: "免费版每月10k字符TTS。Starter $5/月（30k字符+声音克隆）。Pro $22/月（500k字符+专业声音设计）。20%循环佣金",
        website: "https://partnerstack.com/go/elevenlabs/YOUR-PARTNER-CODE",
        tags: ["声音克隆", "TTS", "配音", "声音设计", "有声书"],
        strengths: "全球最顶级的AI语音合成，支持70+语言（含高质量中文普通话/粤语）。声音克隆只需1分钟录音。20%循环佣金 + 低价入门 = 高转化率",
        strengthsEn: "World's top AI voice synthesis with 70+ languages including high-quality Mandarin/Cantonese. Voice cloning from just 1 minute of audio. 20% recurring commission + low entry price = high conversion.",
    ...
    },
    {
        ...
        tagsEn: ["AI Avatar","Video","Multilingual","Training","Corporate"],
        name: "Synthesia",
        company: "Synthesia（英国）",
        category: "AI辅助工具",
        pricing: "paid",
        priceLabel: "Starter $29/月（$22/月按年）",
        priceDetail: "Starter $29/月（1位AI主播，10min视频/月）。Creator $67/月（3位主播，30min）。Enterprise按需定价。30%循环佣金（2年），企业单次推荐$6000+",
        website: "https://partnerstack.com/go/synthesia/YOUR-PARTNER-CODE",
        tags: ["AI主播", "视频", "多语言", "培训", "企业"],
        strengths: "AI数字人播报领域绝对领跑者，140+AI主播形象+120+语言配音。企业用户单次推荐价值$6000+，30%循环佣金是视频工具中最高的之一",
        strengthsEn: "Absolute leader in AI avatar video, 140+ presenter avatars in 120+ languages. Single enterprise referral worth $6,000+ with 30% recurring commission — among the highest in video tools.",
    ...
    },
    {
        ...
        tagsEn: ["AI Writing","Cheap","40+ Templates","Plagiarism","SEO"],
        name: "Rytr",
        company: "Rytr（美国）",
        category: "AI辅助工具",
        pricing: "freemium",
        priceLabel: "免费 / Unlimited $9/月",
        priceDetail: "免费版每月10k字符。Unlimited $9/月（无限生成+丰富模板+查重）。Premium $29/月（团队协作+专属账号管理）。30%终身循环佣金",
        website: "https://partnerstack.com/go/rytr/YOUR-PARTNER-CODE",
        tags: ["AI写作", "超低价", "40+模板", "查重", "SEO"],
        strengths: "AI写作工具中价格最低（$9/月），30%终身循环佣金。40+写作模板覆盖博客/邮件/广告/社媒。适合预算有限的个人和小团队",
        strengthsEn: "Lowest price in AI writing ($9/mo) with 30% lifetime recurring commission. 40+ templates covering blog/email/ad/social media. Perfect for budget-conscious individuals and small teams.",
    ...
    },
    {
        ...
        tagsEn: ["SEO","AI Content","SERP Analysis","Audit","NLP"],
        name: "Surfer SEO",
        company: "Surfer（波兰）",
        category: "AI辅助工具",
        pricing: "paid",
        priceLabel: "Essential $89/月（$69/月按年）",
        priceDetail: "Essential $89/月（15篇文章/月，SERP分析+AI写作+内容评分）。Scale $129/月（30篇）。Enterprise按需。25%终身循环佣金",
        website: "https://partnerstack.com/go/surferseo/YOUR-PARTNER-CODE",
        tags: ["SEO", "AI内容", "SERP分析", "审计", "NLP"],
        strengths: "SEO内容优化领域标杆，25%终身循环佣金。AI驱动SERP分析 + NLP关键词建议 + 内容评分。博客/电商SEO从业者的效率利器",
        strengthsEn: "Gold standard in SEO content optimization with 25% lifetime recurring commission. AI-driven SERP analysis + NLP keyword suggestions + content scoring. Essential for blog/e-commerce SEO practitioners.",
