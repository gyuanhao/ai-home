...
const models = [
{
        ...
        "strengthsEn": "Completely free unlimited use; outstanding reasoning (chain-of-thought); excellent math & coding; native Chinese; V4.1 coming with multimodal (image+audio).",
...
},
{
        ...
        "weaknessesEn": "通用任务不如GPT/Claude前端；部分高级功能需付费",
...
},
{
        ...
        "strengths": "国内首个同时集齐1M超长上下文+原生多模态+前沿编程的模型；SWE-Bench Pro编程 59.0%超越GPT-5.5和Gemini；开源可商用；同厂商海螺视频AI视频生成",
        "strengthsEn": "First Chinese model combining 1M context + native multimodal + cutting-edge coding (59% on SWE-Bench Pro, surpassing GPT-5.5 & Gemini); open-source with commercial license; same company as HailuoAI video.",
        ...
        "weaknessesEn": "生态较新（模型刚发布，工具链/社区在建设中）；对话产品不如主流成熟；品牌认知度待提升",
...
},
{
        ...
        "chineseSupportEn": "★★★★★ 万得出品，中文金融数据最全",
...
},
{
        ...
        "strengthsEn": "Image quality ceiling — V7 delivers unmatched artistic style; Niji 7 professional anime engine; Relax Mode for unlimited slow generation; industry-leading color & lighting.",
...
},
{
        ...
        "strengthsEn": "Best natural language understanding (casual prompts work great); deep ChatGPT integration for gen+edit in one conversation; excellent text rendering; dead-simple, no tuning needed.",
...
},
{
        ...
        "strengthsEn": "Built by original Stable Diffusion team; industry-leading text rendering (signs/UI text crisp & accurate); fast generation; ultra-realistic photorealism.",
...
},
{
        ...
        "weaknesses": "视频质量和控制力不如可灵/Sora；复杂场景一致性偶有翻车；功能丰富度不如Runway",
        ...
        "weaknessesEn": "视频质量和控制力不如可灵/Sora；复杂场景一致性偶有翻车；功能丰富度不如Runway",
...
},
{
        ...
        "strengthsEn": "Image quality ceiling with cinematic polish; incredibly realistic physics & lighting details; ultra-long continuous shots without frame skipping; strong complex camera control.",
        "weaknesses": "生成耗时极长（几分钟到十几分钟/条）；价格昂贵（Pro $200/月才有完整能力）；提示词细节要求极高；新手调试困难",
        "bestFor": "影视级短片、高质量广告、追求极致画质的专业创作者",
        "bestForEn": "Cinematic short films, high-quality ads, professional creators pursuing ultimate image quality",
...
},
{
        ...
        "weaknessesEn": "代码补全质量略逊Copilot/Cursor（特别是英文项目）；高级功能（安全审计等）需付费企业版；更新频率不如海外工具",
...
},
{
        ...
        "weaknessesEn": "知名度不如通义灵码/Copilot；代码补全质量中等偏上；开源社区相对冷清；对非百度技术栈支持一般",
...
},
{
        ...
        "weaknessesEn": "纯付费（个人$10/月）；代码对话不如Cursor灵活深入；国内访问GitHub可能不稳定；不支持多文件Agent式编辑",
...
},
{
        ...
        "bestForEn": "Developers pursuing the ultimate AI coding experience, complex projects requiring whole-project AI understanding",
...
},
{
        ...
        "strengths": "中文品牌名'可画'，国内知名度极高。AI文字生图、智能抠图、批量设计功能强大，对国内中文用户极其友好",
        "strengthsEn": "Branded as '可画' in China with massive local awareness. AI text-to-image, smart background removal, batch design. Extremely Chinese-user-friendly.",
...
},
{
        ...
        "strengths": "企业级AI写作工具标杆，品牌声音训练功能独一无二。平均客户生命周期长，适合中长期获客",
        "strengthsEn": "Enterprise AI writing benchmark with unique brand voice training. Long average customer lifetime, ideal for sustainable customer acquisition.",
        "weaknesses": "价格高（$49/月起）；中文写作能力不如国产工具；面向专业用户，学习曲线陡",
        ...
        "weaknessesEn": "价格高（$49/月起）；中文写作能力不如国产工具；面向专业用户，学习曲线陡",
...
},
{
        ...
        "strengths": "全球最顶级的AI语音合成，支持70+语言（含高质量中文普通话/粤语）。声音克隆只需1分钟录音，$5/月起步极低门槛",
        "strengthsEn": "World's top AI voice synthesis with 70+ languages including high-quality Mandarin/Cantonese. Voice cloning from just 1 minute of audio. Low entry price at $5/mo.",
...
},
{
        ...
        "strengths": "AI数字人播报领域绝对领跑者，140+AI主播形象+120+语言配音。企业场景深度覆盖，适合专业级AI视频制作",
        "strengthsEn": "Absolute leader in AI avatar video, 140+ presenter avatars in 120+ languages. Deep enterprise scenario coverage, perfect for professional AI video production.",
...
},
{
        ...
        "weaknesses": "写作质量不如ChatGPT/Claude；无中文优化；免费版字数太少（10k）",
        ...
        "weaknessesEn": "写作质量不如ChatGPT/Claude；无中文优化；免费版字数太少（10k）",
...
},
{
        ...
        "strengths": "SEO内容优化领域标杆，AI驱动SERP分析 + NLP关键词建议 + 内容评分。博客/电商SEO从业者的效率利器",
        "strengthsEn": "Gold standard in SEO content optimization. AI-driven SERP analysis + NLP keyword suggestions + content scoring. Essential for blog/e-commerce SEO practitioners.",
